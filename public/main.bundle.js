...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__components_post_edit_edit_component__ = __webpack_require__("../../../../../src/app/components/post/edit/edit.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var appRoutes = [
    ...
    {
        path: 'posts',
        component: __WEBPACK_IMPORTED_MODULE_12__components_post_post_component__["a" /* PostComponent */],
        canActivate: [__WEBPACK_IMPORTED_MODULE_13__services_auth_guard_service__["a" /* AuthGuardService */]]
    },
    {
        path: 'posts/edit/:id',
        component: __WEBPACK_IMPORTED_MODULE_17__components_post_edit_edit_component__["a" /* EditComponent */],
        canActivate: [__WEBPACK_IMPORTED_MODULE_13__services_auth_guard_service__["a" /* AuthGuardService */]]
    }
];
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_17__components_post_edit_edit_component__["a" /* EditComponent */]
            ],
            imports: [
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_14__services_validation_service__["a" /* ValidationService */], __WEBPACK_IMPORTED_MODULE_15__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_13__services_auth_guard_service__["a" /* AuthGuardService */], __WEBPACK_IMPORTED_MODULE_16__services_post_service__["a" /* PostService */]],
...
module.exports = "<div class=\"jumbotron\">\n  <h1 class=\"display-3\">MEAN Auth App</h1>\n  <p class=\"lead\">This is a simple Angular application using JWT as authentication.</p>\n  <hr class=\"my-4\">\n  <p>After logged in, you can check your credentials and create some posts to share your thoughts.</p>\n  <p class=\"lead\">\n    <a class=\"btn btn-primary btn-lg\" routerLink=\"/login\" role=\"button\">Login</a> <a class=\"btn btn-primary btn-lg\" routerLink=\"/register\" role=\"button\">Register</a>\n  </p>\n</div>"
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(authService, _flashMessagesService, validationService, router) {
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.loginUser(user).subscribe(function (data) {
            if (data.success) {
                _this.authService.storeToken(data.token, data.user);
                _this._flashMessagesService.show("Welcome back, " + data.user.name, { cssClass: 'alert-success', timeout: 4000 });
...
/***/ "../../../../../src/app/components/post/edit/edit.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/components/post/edit/edit.component.html":
/***/ (function(module, exports) {

module.exports = "<h2>Edit post</h2>\n<hr>\n\n<form [ngFormOptions]=\"{ updateOn: 'submit' }\" class=\"well\" (submit)=\"editPost()\">\n  <div class=\"form-group\">\n    <label class=\"control-label\">Title</label>\n    <input type=\"text\" class=\"form-control\" [(ngModel)]=\"post.title\" name=\"title\">\n  </div>\n  <div class=\"form-group\">\n    <label class=\"control-label\">Content</label>\n    <textarea type=\"text\" class=\"form-control\" [(ngModel)]=\"post.content\" name=\"content\"></textarea>\n  </div>\n  <button type=\"submit\" class=\"btn btn-primary\">Submit</button>\n</form>"
...
var EditComponent = /** @class */ (function () {
    function EditComponent(postService, activatedRoute, router, _flashMessagesService) {
    ...
    EditComponent.prototype.ngOnInit = function () {
        ...
        this.activatedRoute.params.subscribe(function (params) {
            _this.postService.getSinglePost(params['id']).subscribe(function (data) {
                _this.post = data.post;
            });
        });
    };
    EditComponent.prototype.editPost = function (event) {
        var _this = this;
        var editedPost = {
            title: this.post.title,
            content: this.post.content
        };
        this.postService.editPost(editedPost, this.post._id).subscribe(function (data) {
            if (data.success) {
                _this._flashMessagesService.show("Edited post with success", { cssClass: 'alert-success', timeout: 3000 });
                _this.router.navigate(['/posts']);
            }
            else {
                _this._flashMessagesService.show("Sorry, something went wrong", { cssClass: 'alert-success', timeout: 3000 });
                _this.router.navigate(['/posts/edit' + _this.post._id]);
            }
        });
    };
    EditComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-edit',
            template: __webpack_require__("../../../../../src/app/components/post/edit/edit.component.html"),
            styles: [__webpack_require__("../../../../../src/app/components/post/edit/edit.component.css")]
        }),
...
var PostComponent = /** @class */ (function () {
    function PostComponent(postService, validationService) {
        this.postService = postService;
        this.validationService = validationService;
    }
    ...
    PostComponent.prototype.addPost = function () {
        ...
        this.postService.addPost(newPost).subscribe(function (data) {
            _this.getPosts();
        });
    };
    ...
    PostComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__services_post_service__["a" /* PostService */],
            __WEBPACK_IMPORTED_MODULE_2__services_validation_service__["a" /* ValidationService */]])
    ], PostComponent);
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this._flashMessagesService.show("You're registered, please login" + user.name, { cssClass: 'alert-success', timeout: 3000 });
                _this.router.navigate(['/']);
            }
            else {
                _this._flashMessagesService.show(data.err.message, { cssClass: 'alert-danger', timeout: 4000 });
            }
        });
    };
...
var PostService = /** @class */ (function () {
    ...
    PostService.prototype.editPost = function (post, id) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        this.storeToken();
        headers.append('Authorization', this.authToken);
    ...
    PostService.prototype.storeToken = function () {
        this.authToken = localStorage.getItem('token');
    };
